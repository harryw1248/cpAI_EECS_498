...
#INVOICE_TEMPLATE_PATH = 'sample_doc.pdf'
#INVOICE_OUTPUT_PATH = 'sample_doc_output.pdf'

INVOICE_TEMPLATE_PATH = 'f1040_form.pdf'
INVOICE_OUTPUT_PATH = 'f1040_form_output.pdf'
